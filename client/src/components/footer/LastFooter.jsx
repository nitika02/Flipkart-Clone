  ...
  return (
    <>
        ...
        <div className='last-footer-section2'>
            <div className='last-footer-div2'>
            ...
            <div className='last-footer-payment'>
                <img src="//static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/payment-method_69e7ec.svg" alt="" />
            </div>
        </div>
    </>
  )
